      ...
      <header className="d-flex justify-between align-center p-40">
        <div className="headerLeft d-flex align-center">
          ...
          <div className="headerLeft__box">
            <h3 className="headerLeft__title text-uppercase">REACT SNEAKERS</h3>
            <p className="headerLeft__subtitle">Магазин лучших кроссовок</p>
          </div>
        </div>
        <ul className="headerRight d-flex">
          <li className="mr-30 d-flex align-center">
            <svg className="mr-10" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      <div className="content p-40 clear">
        ...
        <div className="d-flex">
          <div className="card mr-30">
            <img className="mb-15" width={133} height={112} src="/img/sneaker-image-1.jpg" alt="" />
